...
import static edu.neu.coe.info6205.huskySort.sort.huskySort.HuskySortBenchmark.runStringSortBenchmark;
...
public class QuickSort3WayTest {
    ...
    public void testPartitionWithSort() {
        ...
        assertEquals(14, privateMethodInvoker.invokePrivate("getFixes"));
        ...
        assertTrue(inversions <= fixes);
        assertEquals(13, privateMethodInvoker.invokePrivate("getSwaps"));
    }
